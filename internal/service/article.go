...
import (
	"github.com/wolf88804/blog-service/internal/dao"
...
type CreateArticleRequest struct {
	Title         string `form:"title" binding:"required,max=100,min=3"`
	Desc          string `form:"desc" binding:"max=100,min=3"`
	CoverImageUrl string `form:"cover_image_url" binding:"max=100,min=3"`
